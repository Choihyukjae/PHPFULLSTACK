...
<h3 style="color: red;" ><?php echo isset($this->errMsg) ? $this->errMsg : "";  ?></h3>
    <h1 style="text-align: center; line-height:1.5;"> <?php if(isset($_SESSION[_STR_LOGIN_ID])){
        echo $_SESSION[_STR_LOGIN_ID]."님의 장바구니 목록입니다" ;
    }?></h1>
<br><br>
                    ...
                    <img src="<?php echo $recode["g_pictur"]?>" class="card-img-top" alt="...">
                        ...
                        <p class="card-text"><?php echo $recode["g_price"]; ?></p>
                            ...
                            <form action= "/user/delete" method ="post" >
                                <button type="submit" class ="btn btn-dark"  style="color:white;" > 장바구니삭제! </button>
                                <?php if(isset($_SESSION["u_id"])){ ?>
                                <input type="hidden" name ="u_no" value ="<?php if(isset($se2["u_no"])){echo $se2["u_no"];}  ?>">
                                <input type="hidden" name ="g_no" value ="<?php if(isset($se2["u_no"])){echo $recode["g_no"];} ?>">
                                <?php } ?>
                            </form>
                            </div>
                        </div>
