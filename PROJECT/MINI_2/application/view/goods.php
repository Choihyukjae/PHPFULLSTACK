        ...
        <div class="row row-cols-xxl-3 row-cols-lg-3 " style="max-width: 60%;">
            <div class="col d-flex justify-content-center pt-3 pb-3">
                <div class="card" style="width: 30rem; border: none; ">
                    <img style="width:600px; height:400px;" src="<?php echo $this->result[0]["g_pictur"]?> " class="card-img-top" alt="...">
                    <div class="card-body">
                        <h6 class="card-title"><p><?php echo $this->result[0]["g_name"]?></p></h6>
                        <p style = "text-align : center;" class="card-text"><?php echo $this->result[0]["g_price"]?></p>
                        <!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            구매하기
                        </button> -->
                        <div style = "text-align : center ;">
                        <form action= "/user/basket" method ="post" >
                        <button type="submit" class ="btn btn-dark"  style="color:white;" > 장바구니에 담기! </button>
                        <?php if(isset($_SESSION["u_id"])){ ?>
                        <input type="hidden" name ="u_no" value ="<?php if(isset($se2["u_no"])){echo $se2["u_no"];} ?>">
                        <input type="hidden" name ="g_no" value ="<?php if(isset($se2["g_no"])){echo $se2["g_no"];} ?>">
                        <?php } ?>
                        </form>
                        </div>
                    </div>
