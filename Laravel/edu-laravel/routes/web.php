...
//뷰 리턴(뷰 파일이 없으면 에러발생, 디버그모드 설정이false 면 500에러 , true 면 에러의 상세정보 출력)
...
// Request 로도 세그먼트 파라미터 획득가능 .세그먼트 파라미터가 없어도 404 에러 발생 안함
...
Route::get('/makesign', function(){
    ...
    //서명된 URL 링크 생성하기
    // $signUrl = URL::signedRoute('invitations', ['invitations' => 5816, 'group' => 678]);
    $signUrl = URL::signedRoute('sign');

    // 유효 기간이 있는 서명된 URL 링크 생성하기
